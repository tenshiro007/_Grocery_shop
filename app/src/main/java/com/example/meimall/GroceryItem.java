...
//parcelable send data by using class
public class GroceryItem implements Parcelable {
    ...
    public GroceryItem( String name, String description, String imageUrl, String category, double price, int avaliableAmount) {
        this.id =Utils.getId();
        this.name = name;
